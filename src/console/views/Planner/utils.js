...
export const initTasks = () => {
	...
	const tasks = [
		// Project 1
		{
			...
			type: "project",
			id: "ProjectSample",
			name: "NSF 23-558 Accelerating Research Translation (ART)",
			start: new Date(2023, 6, 1),
		...
		},
		{
			...
			type: "task",
			id: "Task 2",
			name: "Collaborative Research Plan",
			start: new Date(2023, 6, 1),
			end: new Date(2023, 7, 30),
			progress: 10,
			dependencies: ["Task 1"],
		...
		},
		{
			...
			type: "task",
			id: "Task 4",
			name: "Budget Justification and Approval",
